...
enum API {
  // 查询
  searchUrl = '/pc/tShipinHejiDalei/selectByAll',
  // 启禁用
  enableUrl = '/pc/tShipinHejiDalei/updateQiJinYong',
  // 添加
  addUrl = '/pc/tShipinHejiDalei/saveTShipinHejiDalei',
  // 修改
  editUrl = '/pc/tShipinHejiDalei/updateTShipinHejiDalei',
}
