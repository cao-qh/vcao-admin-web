...
enum API {
  // 查询
  searchUrl = '/pc/tShipinHejiXiaolei/selectByAll',
  // 启禁用
  enableUrl = '/pc/tShipinHejiXiaolei/updateQiJinYong',
  // 添加
  addUrl = '/pc/tShipinHejiXiaolei/saveTShipinHejiXiaolei',
  // 修改
  editUrl = '/pc/tShipinHejiXiaolei/updateTShipinHejiXiaolei',
}
