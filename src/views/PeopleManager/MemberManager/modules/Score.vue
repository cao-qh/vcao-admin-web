	...
	<a-modal title="修改积分" :open="open" @ok="submit" @cancel="open = false">
		<a-form ref="formRef" :model="formState" v-bind="layout" :rules="rules">
			<a-form-item label="编码" name="huiyuanBianma">
				<a-input v-model:value.trim="formState.huiyuanBianma" placeholder="请输入" disabled />
			</a-form-item>
			<a-form-item label="积分" name="jifen">
				<a-input-number :min="0" :precision="0" v-model:value.trim="formState.jifen" placeholder="请输入"
					style="width: 100%" />
			</a-form-item>
		</a-form>
	</a-modal>
